module.exports = {
    ...
    subtitle: function(data) {
        ...
        return `Server: ${servers[parseInt(data.server)]} - Data Name: ${data.dataName || "All"}`;
    },
    ...
    short_description: "Delete a Firebase server data.",
    ...
    action: function(cache) {
        ...
        if (server) {
            try {
                ...
                if (dataName) {
                    firebase.database().ref(`data/servers/${server.id}/${dataName}`).remove();
                } else {
                    firebase.database().ref(`data/servers`).remove();
                }
            } catch(err) {
