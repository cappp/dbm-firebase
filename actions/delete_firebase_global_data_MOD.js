module.exports = {
    ...
    subtitle: function(data) {
        return `Data Name: ${data.dataName || "All"}`;
    },
    ...
    short_description: "Delete a Firebase global data.",
    ...
    action: function(cache) {
        ...
        try {
            ...
            if (dataName) {
                firebase.database().ref(`data/globals/${dataName}`).remove();
            } else {
                firebase.database().ref(`data/globals`).remove();
            }
        } catch(err) {
